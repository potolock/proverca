...
class add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_contacts_form(wd, Group(firstname="krasnova", lastname="natalia", address="moscow", email="potolock@bk.ru", homepage="www.site.ru", address2="frkes", notes="jdfhgkresgkri"))
    ...
    def fill_contacts_form(self, wd, group):
